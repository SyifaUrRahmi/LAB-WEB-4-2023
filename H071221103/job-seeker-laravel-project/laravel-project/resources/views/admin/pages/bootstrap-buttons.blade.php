                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="buttons">
                                    <a href="#"
                                        class="btn btn-primary">Primary</a>
                                    <a href="#"
                                        class="btn btn-secondary">Secondary</a>
                                    <a href="#"
                                    ...
                                    <a href="#"
                                        class="btn btn-light">Light</a>
                                    <a href="#"
                                        class="btn btn-dark">Dark</a>
                                    <a href="#"
                                        class="btn">Link</a>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="buttons">
                                    ...
                                    <a href="#"
                                        class="btn btn-outline-warning">Warning</a>
                                    <a href="#"
                                        class="btn btn-outline-danger">Danger</a>
                                    <a href="#"
                                        class="btn btn-outline-success">Success</a>
                                    <a href="#"
                                        class="btn btn-outline-light">Light</a>
                                    <a href="#"
                                        class="btn btn-outline-dark">Dark</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="buttons">
                                    <a href="#"
                                        class="btn btn-sm btn-warning">Small</a>
                                    <a href="#"
                                        class="btn btn-danger">Normal</a>
                                    <a href="#"
                                        class="btn btn-lg btn-dark">Large</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the <code>.disabled</code> or <code>.btn-progress</code> classes.
                                </p>
                                <div class="buttons">
                                    <a href="#"
                                        class="btn btn-primary">Normal</a>
                                    <a href="#"
                                        class="btn disabled btn-primary">Disabled</a>
                                    <a href="#"
                                        class="btn disabled btn-primary btn-progress">Progress</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the <code>.btn-icon</code> and <code>.icon-left</code> classes.
                                </p>
                                <div class="buttons">
                                    <a href="#"
                                        class="btn btn-icon icon-left"><i class="far fa-user"></i> Default</a>
                                    <a href="#"
                                        class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Primary</a>
                                    <a href="#"
                                        class="btn btn-icon icon-left btn-secondary"><i class="far fa-user"></i>
                                        Secondary</a>
                                    <a href="#"
                                    ...
                                    <a href="#"
                                        ...
                                        Success</a>
                                    <a href="#"
                                        class="btn btn-icon icon-left btn-light"><i class="fas fa-star"></i> Light</a>
                                    <a href="#"
                                        class="btn btn-icon icon-left btn-dark"><i class="far fa-file"></i> Dark</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="buttons">
                                    ...
                                    <a href="#"
                                        class="btn btn-icon btn-secondary"><i class="far fa-user"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-info"><i class="fas fa-info-circle"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-warning"><i class="fas fa-exclamation-triangle"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-danger"><i class="fas fa-times"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-success"><i class="fas fa-check"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-light"><i class="fas fa-star"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-dark"><i class="far fa-file"></i></a>
                                </div>
                                ...
                                <div class="buttons">
                                    ...
                                    <a href="#"
                                        class="btn btn-icon btn-danger"><i class="fas fa-times"></i></a>
                                    <a href="#"
                                        class="btn btn-icon btn-lg btn-success"><i class="fas fa-check"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group mb-3"
                                    ...
                                    aria-label="Basic example">
                                    <button type="button"
                                        class="btn btn-danger">Left</button>
                                    <button type="button"
                                        class="btn btn-warning">Middle</button>
                                    <button type="button"
                                        class="btn btn-success">Right</button>
                                </div>
                                ...
                                <div class="btn-group btn-group-lg"
                                    ...
                                    <button type="button"
                                        class="btn btn-danger">Left</button>
                                    <button type="button"
                                        class="btn btn-danger">Middle</button>
                                    <button type="button"
                            ...
                            <div class="card-body">
                                <div class="btn-group-vertical"
                                    ...
                                    <button type="button"
                                        class="btn btn-secondary">Right</button>
                                    <button type="button"
                                        class="btn btn-secondary">Justify</button>
                                </div>
                            </div>
                        </div>
                    </div>
