...
const resetCardsButton = document.getElementById("btn-reset");
...
startGameButton.addEventListener("click", function () {
  if (parseInt(myMoney.textContent) <= 0) {
    alert("Maaf, uang Anda habis. Silakan isi uang Anda untuk bermain.");
    return;
  }
...
takeCardButton.addEventListener("click", function () {
  ...
  if (mySums > 21) {
    ...
    resultElement.textContent = "YOU LOSEE!";
    ...
    setTimeout(() => {
      ...
      if (botSums < 18) {
        ...
        if (mySums > 21 || mySums % 22 < botSums % 22) {
          message = "YOU LOSEE!";
          uangku -= inputMoney.value
          myMoney.textContent = uangku;
        } else if (botSums > 21 || mySums % 22 > botSums % 22) {
          message = "YOU WINN!"
          uangku += inputMoney.value * 2
          myMoney.textContent = uangku;
...
resetCardsButton.addEventListener("click", function () {
  ...
  function resetGame() {
    ...
    myCardsElement.textContent = "";
    botSumsElement.textContent = ""; 
    botCardsElement.textContent = "";
    inputMoney.value = "";
  }
