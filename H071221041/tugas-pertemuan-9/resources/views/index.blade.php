...
@section('container')
    <div class="d-flex flex-row-reverse mt-4">
        <a href="/product/create" class="btn" style="background-color: #BFA2DB">New Product</a>
    </div>
            ...
            @if ($products->count() > 0)
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td class="align-middle"><a href="product/{{ $product->id }}"
                                class="text-dark">{{ $product->nama }}</a></td>
                        <td class="align-middle">Rp {{ number_format($product->harga, 2, ',', '.') }}
                        </td>
