...
if (isset($_SESSION['status']) && $_SESSION['status'] == 'login' && $_SESSION['role'] != 'admin') {
    header("location:./index.php?message=Lu bukan admin deek dek!");
}
    ...
    <div class="container mt-4 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if ($op == '') {
                ?>
                    <a href="?op=add" class="btn btn-primary">Add</a>
                <?php
                }
                if ($error) {
                ?>
                ...
                ?>
                    <form action="" method="post">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <button type="submit" name="simpan" class="btn btn-primary"><?php if ($op == 'edit') {
                                                                                            echo "Update";
                                                                                        } else {
                                                                                            echo "Add";
                                                                                        } ?></button>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="?op=edit&id=<?= $data['id'] ?>" class="btn btn-sm btn-warning">
                                        Edit
                                    </a>
                                    <a href="?op=delete&id=<?= $data['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-sm btn-danger">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
