...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 fixed w-full z-50">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">NoxBlog</span>
            </a>
    ...
    <footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/"
                    class="hover:underline">Adnan Amiruddin</a>. All Rights Reserved.
            </span>
            <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
                ...
                <li>
                    <a href="/blogs/create" class="hover:underline">Buat Blog</a>
                </li>
            </ul>
        </div>
    </footer>
    ...
    {{-- <script>
        ...
        modalButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                data.forEach(blog => {
                    if (button.value == blog.id) {
                        modalTitle.innerHTML = blog.title;
                        modalBody.innerHTML = blog.body;
                    }
                });
            });
        });
