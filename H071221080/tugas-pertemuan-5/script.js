...
takeCardButton.addEventListener("click", () => {
  ...
  if (mySums > 21) {
    ...
    resultElement[1].textContent = "KALAH: Awokwowk rugi bandar";
    resultImgElement.src = "/images/memes/lose.jpg";
    myMoney.textContent -= inputMoney.value;
    showResultModal();
    setTimeout(() => {
      resultElement[0].textContent = "KALAH: Awokwowk rugi bandar";
    }, 4500);
  }
});
    ...
    setTimeout(() => {
      ...
      if (botSums < 17) {
        ...
        if (mySums > 21 || mySums % 22 < botSums % 22) {
          message = "KALAH: Awokwowk rugi bandar";
          resultImgElement.src = "/images/memes/lose.jpg";
          myMoney.textContent -= inputMoney.value;
          showResultModal();
        } else if (botSums > 21 || mySums % 22 > botSums % 22) {
          message = "MENANG: GACOR KAANGG";
